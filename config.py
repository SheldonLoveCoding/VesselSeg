...
def parse_args():
    ...
    # base dir
    parser.add_argument('--now_dir', default='D:\\VesselSeg\\',
                        help='the base dir')
    # in/out
    parser.add_argument('--outf', default='D:\\VesselSeg\\trainedmodels',
                        help='trained model will be saved at here')
    parser.add_argument('--save', default='AttentionUNet_vessel_seg',
                        help='save name of experiment in args.outf directory')
    # data DRIVE  CHASEDB1s
